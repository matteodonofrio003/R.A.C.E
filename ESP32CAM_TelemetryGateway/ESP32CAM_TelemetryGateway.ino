...
static_assert(sizeof(TelemetryPacket) == 9U,
...
static char latestJson[64] = {0};
static bool latestTelemetryAvailable = false;
...
static void handleWebSocketEvent(AsyncWebSocket *serverInstance,
  ...
  if ((type == WS_EVT_CONNECT) && latestTelemetryAvailable) {
